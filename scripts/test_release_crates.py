...
class ReleasePlannerTests(unittest.TestCase):
    ...
    def test_unchanged_crate_cannot_publish(self) -> None:
        ...
        with self.assertRaises(RuntimeError):
            MODULE.validate_plan_entry("mynd-core", entry, "0.4.0")
    ...
    def test_new_support_crate_starts_at_first_minor(self) -> None:
        entry = {
        ...
        MODULE.validate_plan_entry("mynd-math", entry, "0.4.0")
